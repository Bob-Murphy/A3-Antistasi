...
private ["_markerX","_vehiclesX","_groups","_soldiers","_positionX","_pos","_size","_veh","_staticsX","_garrison","_radius","_countX","_group","_groupMortar","_typeX","_unit"];
...
_countX = 0;
_countGroup = 0;
while {(spawner getVariable _markerX != 2) and (_countX < _radius)} do
	{
