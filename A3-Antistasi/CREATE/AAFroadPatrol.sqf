private ["_soldiers","_vehiclesX","_groups","_base","_posBase","_roads","_typeCar","_arrayAirports","_arrayDestinations","_radius","_road","_veh","_vehCrew","_groupVeh","_group","_groupP","_distanceX","_spawnPoint"];
