...
private ["_markerX","_difficultX","_leave","_contactX","_groupContact","_tsk","_posHQ","_citiesX","_city","_radius","_positionX","_houseX","_posHouse","_nameDest","_timeLimit","_dateLimit","_dateLimitNum","_pos","_countX"];
...
_radius = [_markerX] call A3A_fnc_sizeMarker;
//_houses = nearestObjects [_positionX, ["house"], _radius];
_houses = (nearestObjects [_positionX, ["house"], _radius]) select {!((typeOf _x) in UPSMON_Bld_remove)};
_posHouse = [];
